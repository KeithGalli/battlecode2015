...
public class DataCache {
	...
	public static double[][] cowData = null;
	
	public static int[] jobList = new int[100];
	public static MapLocation[] pastrLocs = new MapLocation[2];
	...
	public static void init(BaseRobot myRobot) {
		...
		if (ourHQLocation.x < mapWidth/2 || ourHQLocation.y < mapHeight/2){
			teamnum = 0;
		}
		else{
			teamnum = 1;
