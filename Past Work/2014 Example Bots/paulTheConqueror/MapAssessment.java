...
public class MapAssessment{
	...
	public static int countObstacles(int x, int y,RobotController rc){//returns a 0 or a 1
		MapLocation test = new MapLocation(x,y);
		int terrainOrdinal = rc.senseTerrainTile(test).ordinal();//0 NORMAL, 1 ROAD, 2 VOID, 3 OFF_MAP
		return ((terrainOrdinal<2&&!rc.senseEnemyHQLocation().equals(test))?0:1);
	}
